...
"Train a classification model: ": "I want you to act as a data scientist and code for me. I have a dataset of `[describe dataset]`. Please build a machine learning model that predicts `[target variable]`.", 

"Automatic machine learning": "I want you to act as an automatic machine learning (AutoML) bot using TPOT for me. I am working on a model that predicts `[...]`.Please write Python code to find the best classification model with the highest AUC score on the test set.",


"Tune Hyperparameter": "I want you to act as a data scientist and code for me. I have trained a `[model name]`. Please write the code to tune the hyperparameters.",

"Explore Data": "I want you to act as a data scientist and code for me. I have a dataset of `[describe dataset]`. Please write code for data visualisation and exploration.",

"Generate Data": "I want you to act as a fake data generator. I need a dataset that has x rows and y columns: `[insert column names]`.",

"Write Regex": "I want you to act as a coder. Please write me a regex in Python that `[describe regex]`.",

"Train Time Series": "I want you to act as a data scientist and code for me. I have a time series dataset `[describe dataset]`. Please build a machine learning model that predicts `[target variable]`. Please use `[time range]` as train and `[time range]` as validation.",

"Address Imbalance Data": "I want you to act as a coder. I have trained a machine learning model on an imbalanced dataset. The predictor variable is the column `[Insert column name]`. In Python, how do I oversample and/or undersample my data?",

"Get Feature Importance": "I want you to act as a data scientist and explain the model's results. I have trained a decision tree model and I would like to find the most important features. Please write the code.",

"Visualize Data with Matplotlib": "I want you to act as a coder in Python. I have a dataset `[name]` with columns `[name]`. `[Describe graph requirements]`.",

"Visualize Image Grid Matplotlib": "I want you to act as a coder. I have a folder of images. `[Describe how files are organised in directory]` `[Describe how you want images to be printed]`.",

"Explain Model with Lime": "I want you to act as a data scientist and explain the model's results. I have trained a `[library name]` model and I would like to explain the output using LIME. Please write the code.",

"Explain Model with Shap": "I want you to act as a data scientist and explain the model's results. I have trained a scikit-learn XGBoost model and I would like to explain the output using a series of plots with Shap. Please write the code.", 

"Write Multithreaded Functions": "I want you to act as a coder. Can you help me parallelize this code across threads in Python?",

"Compare Function Speed": "I want you to act as a software developer. I would like to compare the efficiency of two algorithms that performs the same task in Python. Please write code that helps me run an experiment that can be repeated for 5 times. Please output the runtime and other summary statistics of the experiment. `[Insert functions]`",

"Create NumPy Array": "I want you to act as a data scientist. I need to create a numpy array. This numpy array should have the shape of (x,y,z). Please initialize the numpy array with random values.",

"Write Unit Test": "I want you to act as a software developer. Please write unit tests for the function `[Insert function]`. The test cases are: `[Insert test cases]`",

"Validate Column": "I want you to act as a data scientist. Please write code to test if that my pandas Dataframe `[insert requirements here]`",

"Explain Python": "I want you to act as a code explainer. What is this code doing? `[Insert code]`",

"Explain SQL": "I want you to act as a data science instructor. Can you please explain to me what this SQL code is doing? `[Insert SQL code]`",

"Explain to Undergraduate":"I want you to act as a data science instructor. Explain `[concept]` to an undergraduate.",

"Explain to Professor":"I want you to act as a data science instructor. Explain `[concept]` to a professor.",

"Explain to Business Stakeholder":"I want you to act as a data science instructor. Explain `[concept]` to a business stakeholder.",

"Explain Like Stackoverflow":"I want you to act as an answerer on StackOverflow. You can provide code snippets, sample tables and outputs to support your answer. `[Insert technical question]`",

"Suggest Edge Cases":"I want you to act as a software developer. Please help me catch edge cases for this function `[insert function]`",

"Suggest Dataset":"I want you to act as a data science career coach. I want to build a predictive model for `[...]`. At the same time, I would like to showcase my knowledge in `[...]`. Can you please suggest the five most relevant datasets for my use case?",

"Suggest Portfolio Ideas":"I want you to act as a data science coach. My background is in `[...]` and I would like to `[career goal]`. I need to build a portfolio of data science projects that will help me land a role in `[...]` as a `[...]`. Can you suggest five specific portfolio projects that will showcase my expertise in `[...]` and are of relevance to `[company]`?",

"Suggest Resources":"I want you to act as a data science coach. I would like to learn about `[topic]`. Please suggest 3 best specific resources. You can include `[specify resource type]`",

"Suggest Time Complexity":"I want you to act as a software developer. Please compare the time complexity of the two algorithms below. `[Insert two functions]`",

"Suggest Feature Engineering":"I want you to act as a data scientist and perform feature engineering. I am working on a model that predicts `[insert feature name]`. There are columns: `[Describe columns]`. Can you suggest features that we can engineer for this machine learning problem?",

"Suggest Ab Testing Steps":"I want you to act as a statistician. `[Describe context]` Please design an A/B test for this purpose. Please include the concrete steps on which statistical test I should run.",

"Career Coaching":"I want you to act as a career advisor. I am looking for a role as a `[role name]`. My background is `[...]`. How do I land the role and with what resources exactly in 6 months?",

"Correct Own ChatGPT Code":"Your above code is wrong. `[Point out what is wrong]`. Can you try again?",

"Correct Python Code":"I want you to act as a software developer. This code is supposed to `[expected function]`. Please help me debug this Python code that cannot be run. `[Insert function]`",

"Correct SQL Code":"I want you to act as a SQL code corrector. This code does not run in `[your DBMS, e.g. PostgreSQL]`. Can you correct it for me? `[SQL code here]`",

"Troubleshoot PowerBI Model":"I want you to act as a Power BI modeler. Here is the details of my current project. `[Insert details]`. Do you see any problems with the table?",

"Create Running Average":"I want you to act as a data scientist and write SQL code for me. I have a table with two columns `[Insert column names]`. I would like to calculate a running average for `[which value]`. What is the SQL code that works for PostgreSQL 14?",

"Solve Leetcode Question":"Assume you are given the tables... with the columns... Output the following... `[Question from Data Lemur)`",

"Write Google Sheets Formula":"I want you to act as a bot that generates Google Sheets formula. Please generate a formula that `[describe requirements]`",

"Write R":"I want you to act as a data scientist using R. Can you write an R script that `[Insert requirement here]`",

"Write Shell":"I want you to act as a Linux terminal expert. Please write the code to `[describe requirements]`",

"Write VBA":"I want you to act as an Excel VBA developer. Can you write a VBA that `[Insert function here]`?",

"Format Tables":"I want you to act as a document formatter. Please format the following into a nice table for me to place in Google Docs",
"Summarize Book": "I want you to act as a technical book summarizer. Can you please summarize the book `[name]` with 5 main points?",

"Summarize Paper": "I want you to act as an academic. Please summarise the paper `[...]` in simple terms in one paragraph.",

"Provide Emotional Support": "I want you to provide emotional support to me. `[Explain problem here.]`"
...
FUNCTION_MAP["train machine learning model"] = r'''
...
FUNCTION_MAP["predict heart disease risk"] = r'''
import pandas as pd
from sklearn.model_selection import train_test_split
from sklearn.ensemble import RandomForestClassifier
...
FUNCTION_MAP["generate emergency alerts"] = r'''
import smtplib
...
FUNCTION_MAP["analyze sentiment of twitter data"] = r'''
import tweepy
...
FUNCTION_MAP["predict house prices"] = r'''
from sklearn import datasets
...
FUNCTION_MAP["generate database models"] = r'''
...
FUNCTION_MAP["create rest api"] = r'''
...
FUNCTION_MAP["create blockchain"] = r'''
import hashlib
import time
class Block:
...
FUNCTION_MAP["verify blockchain"] = r'''
...
FUNCTION_MAP["detect fake news"] = r'''
from sklearn.model_selection import train_test_split
...
FUNCTION_MAP["automatic plant disease detection"] = r'''
...
FUNCTION_MAP["predict diabetes risk"] = r'''
from sklearn import datasets
from sklearn.model_selection import train_test_split
from sklearn.ensemble import RandomForestClassifier
...
FUNCTION_MAP["generate air quality report"] = r'''
import pandas as pd
